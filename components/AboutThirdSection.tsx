...
export function AboutThirdSection() {
  return (
  ...
  <span className="inline-block px-4 py-1 rounded-full bg-gradient-to-r from-pink-400 via-blue-400 to-sky-400 text-xs sm:text-sm md:text-lg shadow-lg tracking-wide border-2 border-white/70 animate-bounce-slow hover:scale-105 transition-transform duration-200 select-none text-white">
    Rich Question Media & AI
      ...
      <div className="absolute top-0 left-0 w-52 h-52 bg-pink-200 rounded-full opacity-30 blur-3xl animate-pulse-slow pointer-events-none" style={{ zIndex: 0 }} />
      <div className="absolute bottom-0 right-0 w-72 h-72 bg-blue-200 rounded-full opacity-30 blur-3xl animate-pulse-slower pointer-events-none" style={{ zIndex: 0 }} />
      <div
        className="absolute top-1/2 left-1/2 w-[24rem] h-[24rem] rounded-full opacity-10 pointer-events-none"
        style={{
          background: `radial-gradient(circle at 60% 40%, #ec4899 0%, transparent 70%)`,
  ...
  <span className="font-semibold text-xs sm:text-sm md:text-base">Media & AI Powered</span>
            ...
            <div className="absolute -inset-4 rounded-3xl border-4 border-pink-200 opacity-40 group-hover:opacity-70 transition-all duration-300 pointer-events-none "></div>
          </div>
          {/* Decorative animated gradient bar */}
          <div className="w-64 h-3 rounded-full bg-gradient-to-r from-pink-400 via-blue-400 to-sky-400 opacity-70 blur-sm animate-gradient-x" />
        <FeatureCard
              icon={
                <svg width="32" height="32" fill="none" viewBox="0 0 24 24" className="text-sky-500">
                  <rect x="4" y="4" width="16" height="16" rx="4" stroke="currentColor" strokeWidth="2" />
                  <circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="2" />
                  <path d="M4 16l4-4a3 3 0 014 0l4 4" stroke="currentColor" strokeWidth="2" />
                </svg>
              }
              title="Question Image"
              desc="Support for one image per question to make concepts clearer and more engaging."
              gradient="from-sky-100 to-pink-50"
            />
            {/* <FeatureCard
              icon={
              ...
              desc="Let AI instantly write options, descriptions, and solutions for every question."
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-2xl mt-4">
            <FeatureCard
              ...
              title="YouTube Video"
              desc="Attach one long YouTube video to each question for in-depth explanations."
              gradient="from-pink-100 to-blue-50"
            />
            <FeatureCard
              icon={
              ...
              desc="Add up to 3 YouTube Shorts for quick, visual learning with every question."
              gradient="from-blue-100 to-pink-50"
            />
...
// FeatureCard component for AboutThirdSection
function FeatureCard({
  ...
  return (
    ...
    >
      <span className="inline-flex items-center justify-center rounded-full bg-white shadow-lg mb-3 p-3 border border-gray-100 group-hover:bg-pink-50 transition-colors duration-200">
        {icon}
      </span>
      <div className="font-bold text-gray-900 mb-1 text-base sm:text-lg group-hover:text-pink-600 transition-colors duration-200">{title}</div>
